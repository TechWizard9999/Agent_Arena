...
class AgentArenaEnvironment(Environment[AgentArenaAction, AgentArenaObservation, AgentArenaState]):
    ...
    def __init__(self) -> None:
        ...
        self._api_base_url = os.getenv("API_BASE_URL", "http://localhost:8080/v1")
        self._model_name = os.getenv("MODEL_NAME", "meta-llama/Llama-3-8B-Instruct")
    ...
    def reset(
        ...
        **kwargs,
        ...
        self._task = get_task_definition(task_id)
        self._env = ArenaEnv(build_task_config(task_id))
    ...
    def get_metadata(self) -> EnvironmentMetadata:
        ...
        description = (
            ...
            f"{task_list}\n\n"
            f"Runtime configuration: API_BASE_URL={self._api_base_url}, MODEL_NAME={self._model_name}"
        )
